...
export const editableRootStyle = {
  '--slot4-page-bg': '#fff7f5',
  '--slot4-page-text': '#221f2b',
  '--slot4-panel-bg': '#f1ebff',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#555162',
  '--slot4-soft-muted-text': '#706b7c',
  '--slot4-accent': '#5f35b2',
  '--slot4-accent-fill': '#5f35b2',
  '--slot4-accent-soft': '#ebe5ff',
  '--slot4-dark-bg': '#24232e',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#f2eef8',
  '--slot4-cream': '#fff7f5',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#f4f0ff',
  '--slot4-gray': '#f7f7fa',
  '--slot4-coral': '#ff4b36',
  '--slot4-teal': '#11c5b7',
  '--slot4-blue': '#3f7ff1',
  '--slot4-body-gradient': 'linear-gradient(180deg, #fff7f5 0%, #ffffff 42%, #f7f7fa 100%)',
} as CSSProperties
