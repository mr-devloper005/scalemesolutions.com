      ...
      <main style={archiveVars} className="bg-[var(--archive-bg)] text-[var(--archive-text)]">
        <section className="mx-auto grid max-w-[var(--editable-container)] gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-14">
          ...
          <form action={basePath} className="self-end rounded-lg border border-[var(--editable-border)] bg-white p-5 shadow-sm">
            ...
            <button className="mt-3 h-12 w-full rounded-full bg-[var(--archive-accent)] text-sm font-black text-white">Apply</button>
        ...
        <section className="mx-auto max-w-[var(--editable-container)] px-4 pb-16 sm:px-6 lg:px-8">
          {posts.length ? (
            ...
            <div className="rounded-lg border border-dashed border-[var(--editable-border)] bg-white p-10 text-center">
    ...
    <Link href={href} className="group grid gap-5 rounded-lg border border-[var(--editable-border)] bg-white p-5 shadow-[0_12px_36px_rgba(15,23,42,0.07)] transition hover:-translate-y-1 hover:shadow-xl sm:grid-cols-[128px_1fr]">
      ...
      <div className="min-w-0">
        <div className="flex flex-wrap gap-2">
          <span className="rounded-full bg-[#f4f0ff] px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-[#5f35b2]">Verified directory</span>
        ...
        <div className="mt-2 flex items-center gap-1 text-sm font-bold text-[#ff4b36]">★★★★★ <span className="ml-1 text-[#555162]">Buyer profile</span></div>
        ...
        <p className="mt-5 inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.16em] text-[#5f35b2]">View business details <ArrowRight className="h-4 w-4 transition group-hover:translate-x-1" /></p>
      </div>
    </Link>
  )
}
