...
export function EditableContactLeadForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-lg border border-[var(--editable-border)] bg-white p-6 shadow-2xl shadow-black/5 md:p-8">
      ...
      <button type="submit" disabled={status === 'submitting'} className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 rounded-full bg-[#5f35b2] px-6 text-sm font-black uppercase tracking-[0.12em] text-white shadow-lg transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-70">
